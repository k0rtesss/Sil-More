"""Exercise Silmaril and Iron Crown ownership across expandable Harness storage."""
...
OUT = ROOT / "scripts/output/silmaril-possession"
...
def main():
    ...
    rsp.write_text("\n".join('"' + p + '"' for p in objects if not p.endswith(
        ("/src/main.c.obj", "/src/score/score_entry.c.obj"))))
    env = os.environ.copy()
    ...
    subprocess.run(["C:/msys64/mingw64/bin/cc.exe", "-DUSE_SDL", "-std=c17", "-O0", "-g",
        "@CMakeFiles/sil-more.dir/includes_C.rsp", str(ROOT / "scripts/tests/silmaril-possession-test.c"),
