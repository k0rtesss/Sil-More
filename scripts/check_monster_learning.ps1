...
try {
    ...
    & C:\msys64\mingw64\bin\gcc.exe -std=c17 -O1 -flto -fwhole-program -Wall -Wextra -Werror -DUSE_SDL `
        -I src -I external/SDL/include scripts/tests/monster-learning-test.c `
        src/monster/monster-ai.c src/monster/monster-social.c -o "$learningDir/test.exe"
