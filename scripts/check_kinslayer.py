"""Exercise production Kinslayer score updates using in-memory SDL streams."""
...
OUT = ROOT / "scripts/output/kinslayer"
...
def main():
    ...
    subprocess.run(["C:/msys64/mingw64/bin/cc.exe", "-DUSE_SDL", "-std=c17", "-O0", "-g",
        "@CMakeFiles/sil-more.dir/includes_C.rsp", str(ROOT / "scripts/tests/kinslayer-test.c"),
