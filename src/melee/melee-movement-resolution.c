/* File: melee/melee-movement-resolution.c */
/*
...
/*
 * Monster movement resolution and side effects split from
 * melee-movement.c for ownership reduction.
 */
        ...
        if (cave_m_idx[ny][nx] > 0)
        {
            ...
            else
            {
                ...
                if (!cave_exist_mon(nr_ptr, m_ptr->fy, m_ptr->fx, true, true))
                {
                    ...
                    if (!melee_movement_push_aside(m_ptr, n_ptr))
                    {
