...
extern ang_file* ang_file_open_path(cptr file, cptr mode);
extern ang_file* ang_file_open_temp_path(char* buf, size_t max);
extern ang_file* ang_file_create_path(cptr file, int mode);
extern errr ang_file_close_path(ang_file* stream);
extern errr ang_file_read_line(ang_file* stream, char* buf, size_t n);
extern errr ang_file_write_line(ang_file* stream, cptr buf, size_t n);
