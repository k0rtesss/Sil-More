...
void do_cmd_tunnel(void)
{
    ...
    else
    {
        ...
        more = cmd_interact_tunnel_aux(y, x);
    }
...
void do_cmd_disarm(void)
{
    ...
    /* Count visible traps */
    num_traps = cmd_interact_count_feats(&y, &x, cmd_interact_is_trap, true);

    /* Count chests (trapped) */
    num_chests = cmd_interact_count_chests(&y, &x, true);
    ...
    {
        /* Disarm the chest */
        more = cmd_interact_disarm_chest(y, x, o_idx);
    }
