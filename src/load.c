...
static errr rd_extra(void)
{
    ...
    /* quest_reserved array grew again in 0.9.5.8; read available bytes safely */
    int quest_reserved_len = savefile_version_at_least(0, 9, 5, 8) ? (int)N_ELEMENTS(p_ptr->quest_reserved) :
