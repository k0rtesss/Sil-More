...
/* Get default encoded color for current depth. */
byte get_depth_color(int depth)
{
    return cave_visuals_get_depth_color(depth);
}
...
{
    cave_visuals_set_feat_with_color(y, x, feat, color);
}
...
{
    cave_visuals_set_feat_with_color(y, x, feat, 0);
}
