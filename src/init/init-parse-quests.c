...
errr parse_quest_info(char* buf, header* head)
{
    ...
    else if (buf[0] == 'Z')
    {
        ...
        else if (1 == sscanf(buf + 2, "%31s", vala_name))
        {
            ...
            else if (SDL_strcasecmp(vala_name, "Nienna") == 0
                || SDL_strcasecmp(vala_name, "Niena") == 0)
                vala_id = VALA_NIENNA;
    ...
    else if (buf[0] == 'H')
    {
        ...
        {
            if (SDL_strcasecmp(challenge_name, "DISCONNECTED") == 0
                || SDL_strcasecmp(challenge_name, "DISCON") == 0)
                challenge_id = CHALLENGE_DISCONNECTED;
            else if (SDL_strcasecmp(challenge_name, "SINGLE_STAIR") == 0
                || SDL_strcasecmp(challenge_name, "SINGLE") == 0)
                challenge_id = CHALLENGE_SINGLE_STAIR;
            else if (SDL_strcasecmp(challenge_name, "FIXED_50K") == 0
                || SDL_strcasecmp(challenge_name, "FIXED_50K_XP") == 0
                || SDL_strcasecmp(challenge_name, "FIXED_XP") == 0)
                challenge_id = CHALLENGE_FIXED_50K_XP;
            else if (SDL_strcasecmp(challenge_name, "TULKAS_BLUNT") == 0
                || SDL_strcasecmp(challenge_name, "BLUNT") == 0)
                challenge_id = CHALLENGE_TULKAS_BLUNT;
            else if (SDL_strcasecmp(challenge_name, "TORCHLIGHT") == 0
                || SDL_strcasecmp(challenge_name, "TORCH") == 0)
