/* File: init-parser-core.c */

/*
 * Core template parsing helpers extracted from init1.c.
 */
 ...
 *
 * Returns false when there isn't enough space available to store the text.
 */
 ...
 *
 * Returns 0 when there isn't enough space available to store the name.
 */
