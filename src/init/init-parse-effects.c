...
errr parse_effect_info(char* buf, header* head)
{
    ...
    else if (buf[0] == 'G')
    {
        ...
        misc_to_attr[effect_idx] = glyphs[effect_idx].d_attr;
        misc_to_char[effect_idx] = (char)glyphs[effect_idx].d_char;
    }
    ...
    else if (buf[0] == 'T')
    {
        ...
        misc_to_attr[effect_idx] = glyphs[effect_idx].x_attr;
        misc_to_char[effect_idx] = (char)glyphs[effect_idx].x_char;
    }
