...
typedef enum app_ui_panel_style {
    ...
    APP_UI_PANEL_STYLE_HUB = 10,
    APP_UI_PANEL_STYLE_COMPACT_OVERLAY = 11,
    APP_UI_PANEL_STYLE_DOCUMENT = 12,
    APP_UI_PANEL_STYLE_ITEM_BROWSER = 13,
    APP_UI_PANEL_STYLE_CRAFTING = 14,
    APP_UI_PANEL_STYLE_MAP_RECALL = 15
} app_ui_panel_style;
