...
/*
 * Meta States core owns only the metarun-local DB container format,
 * path construction, filtering, and lifecycle hooks. Feature agents own
 * artefact/monster/dungeon gameplay semantics and may extend the payload
 * structs below while preserving the common prefix and API names.
 */
