...
#define METARUN_QUEST_TULKAS_ORCS (1UL << 12) /* Tulkas second quest completed */
#define METARUN_QUEST_TULKAS_MORGOTH (1UL << 13) /* Tulkas third quest completed */
#define METARUN_QUEST_VARDA_SHADOW (1UL << 14) /* Varda second quest completed */
#define METARUN_QUEST_VARDA_UNGOLIANT (1UL << 15) /* Varda third quest completed */
...
#define METARUN_SLOT_MANDOS_RES_CHARGES 0
#define METARUN_SLOT_OROME_GREAT_HUNT_MASK 1
#define METARUN_SLOT_OROME_GREAT_HUNT_ACTIVE 2
#define METARUN_SLOT_NIENA_CURSE_CLEANSE 3
/* ------------------------------------------------------------------ */
 ...
 *   0.9.6.0 - Current meta-file version (matches game release)
 */
...
void metarun_add_mandos_resurrection_charge(void);  /* Grant a Mandos resurrection charge */
bool metarun_consume_mandos_resurrection_charge(void); /* Spend a Mandos resurrection charge */
int metarun_niena_curse_cleanses(void);             /* Stored Niena curse-cleansing charges */
void metarun_add_niena_curse_cleansing_charge(void); /* Grant a Niena curse-cleansing charge */
bool metarun_consume_niena_curse_cleansing_charge(void); /* Spend a Niena curse-cleansing charge */
byte metarun_orome_great_hunt_mask(void);           /* Persisted Orome great hunt unique kill mask */
void metarun_set_orome_great_hunt_mask(byte mask);  /* Set the persisted Orome great hunt mask */
bool metarun_orome_great_hunt_active(void);         /* Whether the Orome great hunt is active */
void metarun_set_orome_great_hunt_active(bool active); /* Toggle the Orome great hunt active flag */
...
void metarun_unlock_challenge_disconnected(void);   /* Unlock the disconnected stair challenge */
bool metarun_challenge_single_stair_unlocked(void); /* Has the single-stair challenge been unlocked? */
void metarun_unlock_challenge_single_stair(void);   /* Unlock the single-stair challenge */
bool metarun_challenge_fixed_exp_unlocked(void);    /* Has the fixed-50k XP challenge been unlocked? */
void metarun_unlock_challenge_fixed_exp(void);      /* Unlock the fixed-50k XP challenge */
bool metarun_challenge_tulkas_blunt_unlocked(void); /* Has the Tulkas blunt challenge been unlocked? */
void metarun_unlock_challenge_tulkas_blunt(void);   /* Unlock the Tulkas blunt challenge */
bool metarun_challenge_torchlight_unlocked(void);   /* Has the torchlight challenge been unlocked? */
void metarun_unlock_challenge_torchlight(void);     /* Unlock the torchlight challenge */
