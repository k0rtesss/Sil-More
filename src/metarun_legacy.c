...
void metarun_from_v11_compact(metarun *dst, const metarun_v11_compact *src)
{
    ...
    memset(dst->quest_completion_counts, 0, sizeof(dst->quest_completion_counts));
    memcpy(dst->quest_completion_counts, src->quest_completion_counts, sizeof(src->quest_completion_counts));
    ...
    metarun_sanitize_major_blessing_bits(dst);
}
