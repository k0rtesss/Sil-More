 ...
 */
#define SCREEN_HGT (platform_frame_main_grid_rows() - ROW_MAP - 1 - (op_ptr ? op_ptr->main_combat_rolls : 0))
/*
 * Number of grids in each screen (horizontally)
 */
#define SCREEN_WID ((platform_frame_main_grid_cols() - COL_MAP - 1) / (use_bigtile ? 2 : 1))
/*
 ...
 */
#define SIL_UI_COMPACT_HEIGHT (platform_frame_main_grid_rows() < 24)
...
#define ROW_HUNGRY (platform_frame_main_grid_rows() - 1)
#define COL_HUNGRY 0 /* "Starving" "Weak" / "Hungry" / "Full" */

#define ROW_BLIND (platform_frame_main_grid_rows() - 1)
#define COL_BLIND 9 /* "Blind" */

#define ROW_CONFUSED (platform_frame_main_grid_rows() - 1)
#define COL_CONFUSED 15 /* "Confused" */

#define ROW_STUN (platform_frame_main_grid_rows() - 1)
#define COL_STUN 24 /* <stun> */

#define ROW_AFRAID (platform_frame_main_grid_rows() - 1)
#define COL_AFRAID 36 /* "Afraid" */

#define ROW_STATE (platform_frame_main_grid_rows() - 1)
#define COL_STATE 43 /* <state> */

#define ROW_SPEED (platform_frame_main_grid_rows() - 1)
#define COL_SPEED 56 /* "Slow" or "Fast" */

#define ROW_TERRAIN (platform_frame_main_grid_rows() - 1)
#define COL_TERRAIN 61 /* "Web" or "Pit" or "Sun" */

#define ROW_PARTITION (platform_frame_main_grid_rows() - 1)
#define COL_PARTITION 66 /* "Room"/"Ruin"/"Cave"/"BigCa"/"Labir"/"Chasm" */

#define ROW_DEPTH (platform_frame_main_grid_rows() - 1)
...
static const quest_mapping quest_id_map[] = {
    ...
    { QUEST_ID_OROME_DRAGONS, "Oromë, Warden of the Drakes" },
    { QUEST_ID_OROME_GREAT_HUNT, "Oromë, Hunt of the Great" },
