...
extern int monster_unlight_ally_scale_percent(const monster_type* m_ptr);
extern int monster_scaled_value(const monster_type* m_ptr, int value);
extern int monster_base_armour_dice(const monster_type* m_ptr);
extern void monster_scale_blow_damage(
    const monster_type* m_ptr, int* dd, int* ds);
...
extern void manwe_light_continuation_if_needed(void);
extern bool manwe_unlight_is_ally_defeat_target(const monster_type* m_ptr);
extern bool manwe_unlight_on_ally_defeated(monster_type* m_ptr);
extern void manwe_light_cutscene_start_if_needed(void);
extern bool manwe_light_cutscene_on_monster_slain(int r_idx);
extern bool manwe_light_cutscene_resolved_this_run(void);
extern bool manwe_light_cutscene_record_fall(void);
extern bool monster_is_unlight_final_ally(const monster_type* m_ptr);
extern bool manwe_unlight_final_on_morgoth_slain(void);
extern bool manwe_unlight_final_victory_this_run(void);
