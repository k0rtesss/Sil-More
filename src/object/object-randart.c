...
static bool add_one_resist(artefact_type* a_ptr, u32b avail_flags)
{
    ...
    for (i = 0; i < 32; i++)
    {
        /*the flag is part of teh mask, and the artefact doesn't already have
         * it*/
...
static void build_freq_table(artefact_type* a_ptr)
{
    ...
    case TV_GLOVES:
    {
         ...
         * there is no turning back when creating an adult random artefact game.
         * -JG
         */
    default:
        return;
    ...
    /*High resists and immunities are determined by artefact depth, not a
     * frequency table*/
 ...
 * table.  A pointer to the frequency array (which must be of size
...
static void add_feature_aux(artefact_type* a_ptr, int choice)
{
    ...
    case CAT_WEIGH_LESS:
    {
        ...
        /*hack - we also limit how often we do this, and only once for less than
         * 5 lbs*/
