    ...
    char* buf, size_t max, const object_type* o_ptr, int pref, int mode)
{
    ...
    else if (o_ptr->tval == TV_CHEST)
    {
        ...
        else
        {
            ...
            {
            case 0: tail = " (Locked)"; break;
            case CHEST_GAS_CONF: tail = " (Gas Trap)"; break;
            case CHEST_GAS_STUN: tail = " (Gas Trap)"; break;
            case CHEST_GAS_POISON: tail = " (Gas Trap)"; break;
            case CHEST_NEEDLE_HALLU: tail = " (Poison Needle)"; break;
            case CHEST_NEEDLE_ENTRANCE: tail = " (Poison Needle)"; break;
            case CHEST_NEEDLE_LOSE_STR: tail = " (Poison Needle)"; break;
            case CHEST_FLAME: tail = " (Flame Trap)"; break;
            default: tail = " (Multiple Traps)"; break;
            }
        }
